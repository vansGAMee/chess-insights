...
4. Build the C++ module: `cd analyzer && python setup.py build_ext --inplace`
5. Run: `python analyzer/fetch_and_analyze.py`
6. Serve the dashboard locally (required to load `stats.json`):
   - Using Python 3: `python -m http.server 8000 -d docs/`
   - Or with Node.js: `npx serve docs/`
